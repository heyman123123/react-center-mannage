    ...
    <Popover.Root open={open} onOpenChange={setOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          side={side}
          sideOffset={8}
          className="z-[9999] w-64 rounded-xl border border-line bg-surface p-3 shadow-2xl animate-in fade-in zoom-in-95 outline-none"
        >
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0">
              <div className="text-xs font-bold text-fg leading-snug">
                {title}
              </div>
              {description && (
          ...
          <div className="flex items-center justify-end gap-1.5 mt-3 pt-2 border-t border-line-subtle">
            <button
              type="button"
            ...
            <button
              ...
              className={cn(
                "px-3 py-1.5 rounded-lg text-[11px] font-semibold bg-rose-600 hover:bg-rose-700 text-white shadow-card transition-colors cursor-pointer",
                okClassName
              )}
            >
              {confirmText}
