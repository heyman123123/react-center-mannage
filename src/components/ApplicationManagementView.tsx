    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-xs">
        ...
        <button
          ...
          className="px-3.5 py-2 bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-xs transition-colors shrink-0"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-zinc-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-mono text-zinc-900 mt-1">
            {appList.length} <span className="text-xs font-normal text-zinc-400">个应用</span>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-zinc-200/80 shadow-xs">
          ...
          <div className="text-[11px] text-zinc-500 mt-0.5">包含 Stripe / PayPal / Adyen 全渠道</div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-zinc-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-mono text-zinc-900 mt-1">
            {totalSubscribers.toLocaleString()} <span className="text-xs font-normal text-zinc-400">位订户</span>
          </div>
          <div className="text-[11px] text-zinc-500 mt-0.5">北美、西欧及亚太全球受众</div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-zinc-200/80 shadow-xs">
          ...
          <div className="text-2xl font-bold font-mono text-zinc-900 mt-1">
            6 <span className="text-xs font-normal text-zinc-400">大主流语系</span>
          </div>
          <div className="text-[11px] text-zinc-500 mt-0.5">收银台与邮件多语言统一字典联动</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {appList.map((app) => {
          ...
          return (
            <div
              key={app.id}
              className="bg-white border border-zinc-200/80 hover:border-zinc-300 rounded-2xl p-5 shadow-xs transition-all flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="font-bold text-zinc-900 text-sm">{app.name}</h3>
                    ...
                    <p className="text-xs text-zinc-500 mt-1 line-clamp-1">{app.description}</p>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[11px] font-mono text-zinc-400">
                        Code: <strong className="text-zinc-700">{app.code}</strong>
                      </span>
                      {tenantInfo && (
                  ...
                  <div className="text-right shrink-0">
                    <span className="text-[10px] text-zinc-400 block">累计 GMV</span>
                ...
                {/* API Credentials Box */}
                <div className="bg-zinc-50 rounded-xl p-3 border border-zinc-200/70 space-y-2 text-xs font-mono">
                  {/* Publishable Key */}
                  <div>
                  ...
                  <div className="flex items-center gap-2 flex-wrap text-[11px]">
                    ...
                    <span className="text-zinc-700 font-medium">
                      {app.associatedProductCodes && app.associatedProductCodes.length > 0 ? (
                        ...
                        <span className="text-zinc-400">全部通用方案</span>
                      )}
                    </span>
              ...
              <div className="mt-4 pt-3 border-t border-zinc-100 flex items-center justify-between text-xs">
                <span className="text-zinc-400 text-[11px]">创建于: {app.createdAt}</span>

                <div className="flex items-center gap-2">
                  <button
                    onClick={() => setViewingDetailApp(app)}
                    className="px-2.5 py-1.5 text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 rounded-lg font-medium transition-colors"
                  >
                    配置概览
                  </button>
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg font-medium flex items-center gap-1 transition-colors"
                  >
      ...
      {isConfigModalOpen && (
            ...
            <div className="flex items-center justify-between w-full">
              <div>
                {currentStep > 1 && (
                  <button
                    ...
                    className="px-3.5 py-1.5 border border-zinc-200 text-zinc-700 rounded-xl font-medium flex items-center gap-1 hover:bg-zinc-50 text-xs cursor-pointer"
                  >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-1.5 border border-zinc-200 text-zinc-700 rounded-xl font-medium hover:bg-zinc-50 text-xs transition-colors cursor-pointer"
                >
                  取消
                </button>
                ...
                {editingAppId && currentStep < 6 && (
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-800 rounded-xl font-semibold flex items-center gap-1.5 text-xs transition-colors cursor-pointer"
                    title="快速保存当前所做修改"
                  >
                ...
                {currentStep < 6 ? (
                  <button
                    ...
                    className="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold flex items-center gap-1 text-xs shadow-xs cursor-pointer transition-colors"
                  >
                    <span>下一步</span>
                  ...
                  <button
                    ...
                    className="px-5 py-1.5 bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl font-bold flex items-center gap-1.5 text-xs shadow-xs cursor-pointer transition-colors"
                  >
        ...
        >
          <div className="space-y-4">
            ...
            <div className="pb-3 border-b border-zinc-100 flex items-center justify-between overflow-x-auto gap-2 text-xs">
              {[
            ...
            <div className="text-xs space-y-4">
              ...
              {currentStep === 1 && (
                <div className="space-y-3 animate-in fade-in">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-zinc-700 block mb-1 font-semibold">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg text-zinc-900 focus:bg-white text-xs font-medium"
                      />
                    </div>
                    <div>
                      <label className="text-zinc-700 block mb-1 font-semibold">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg font-mono text-zinc-900 focus:bg-white text-xs font-bold"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      <label className="text-zinc-700 block mb-1 font-semibold">业务归属单元:</label>
                      <ShadcnSelect
                        value={formTenantId}
                    ...
                    <div>
                      <label className="text-zinc-700 block mb-1 font-semibold">运行环境:</label>
                      <ShadcnSelect
                        value={formEnv}
                    ...
                    <div>
                      <label className="text-zinc-700 block mb-1 font-semibold">默认基准结算货币:</label>
                      <ShadcnSelect
                        value={formCurrency}
                  ...
                  <div>
                    <label className="text-zinc-700 block mb-1 font-semibold">应用定位描述:</label>
                    <textarea
                      rows={2}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg font-mono text-zinc-900 text-xs"
                    />
                  ...
                  <div className="bg-zinc-50 rounded-xl p-3.5 border border-zinc-200 space-y-2 font-mono text-xs">
                    <div className="text-[11px] font-sans font-bold text-zinc-700 flex items-center justify-between">
                    ...
                    <div>
                      <span className="text-[10px] text-zinc-400 block font-sans">Publishable Key:</span>
                      <span className="text-zinc-800 break-all">{formPublishableKey}</span>
                    </div>
                    <div>
                      <span className="text-[10px] text-zinc-400 block font-sans">Secret Key:</span>
                      <span className="text-zinc-800 break-all">{formSecretKey}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="space-y-4 animate-in fade-in">
                  {/* Gateways */}
                  <div>
                    <label className="text-zinc-800 block mb-1.5 font-semibold text-xs">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-[11px] text-zinc-500 mt-0.5 leading-snug">{ch.desc}</p>
                            </div>
                          </label>
                        );
                      })}
                        ...
                        return (
                          <label
                            ...
                            className={`flex items-center gap-2.5 p-2.5 rounded-lg border text-xs cursor-pointer ${
                              isChecked
                                ? "bg-blue-50/50 border-blue-300 text-zinc-900 font-medium"
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div>{pm.name}</div>
                              <span className="text-[10px] text-zinc-400">承载: {pm.channelCategory}</span>
                            </div>
                          </label>
                        );
                      })}
                  ...
                  {/* Routing Strategy */}
                  <div className="pt-2 border-t border-zinc-100">
                    <label className="text-zinc-800 block mb-1 font-semibold text-xs">
                        ...
                        >
                          ...
                          <p
                            className={`text-[10px] mt-1 ${
                              formRoutingStrategy === strat.key ? "text-zinc-300" : "text-zinc-400"
                            }`}
                          >
                            {strat.desc}
                          </p>
              ...
              {currentStep === 3 && (
                <div className="space-y-3 animate-in fade-in">
                  ...
                  <div className="bg-zinc-50 rounded-xl border border-zinc-200 max-h-64 overflow-y-auto divide-y divide-zinc-200">
                    {products.map((p) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                <span className="font-mono font-bold text-zinc-900 text-xs">{p.code}</span>
                                <span className="text-[10px] bg-zinc-200 text-zinc-700 px-1 rounded font-mono font-bold">
                                  {p.currency || "USD"}
                                </span>
                              </div>
                              <div className="text-[11px] text-zinc-600 mt-0.5">{p.name}</div>
                            </div>
                          </div>
                  ...
                  <div className="p-2.5 bg-zinc-100 rounded-lg text-zinc-600 text-[11px] flex items-center justify-between">
                    <span>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-2.5">
                            ...
                            />
                            <div>
                              <div className="flex items-center gap-1.5 font-mono font-bold text-zinc-900 text-xs">
                                <Tag className="w-3.5 h-3.5 text-amber-500" />
                                <span>{d.code}</span>
                              </div>
                              <div className="text-[11px] text-zinc-600 mt-0.5">{d.name}</div>
                              <p className="text-[10px] text-zinc-400 mt-1">{d.description}</p>
                            </div>
                          </div>
              ...
              {currentStep === 5 && (
                <div className="space-y-4 animate-in fade-in">
                  ...
                  <div className="pt-2 border-t border-zinc-100">
                    <label className="text-zinc-800 block mb-2 font-semibold text-xs">
                        ...
                        return (
                          <label
                            ...
                            className={`flex items-start gap-2.5 p-2.5 rounded-xl border text-xs cursor-pointer transition-colors ${
                              isChecked ? "bg-indigo-50/40 border-indigo-200" : "bg-zinc-50 border-zinc-200"
                            }`}
                          >
                            <input
                              type="checkbox"
                            ...
                            />
                            <div>
                              <div className="font-semibold text-zinc-900">{evt.label}</div>
                              <div className="text-[10px] text-zinc-400 mt-0.5">{evt.desc}</div>
                            </div>
                          </label>
                        );
                      })}
              ...
              {currentStep === 6 && (
                <div className="space-y-4 animate-in fade-in">
                        ...
                        return (
                          <label
                            ...
                            className={`flex items-center gap-3 p-3 rounded-xl border text-xs cursor-pointer transition-all ${
                              isChecked
                                ? "bg-indigo-50/50 border-indigo-300 ring-1 ring-indigo-200 font-medium text-zinc-900"
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <div className="font-bold text-xs text-zinc-900">{l.label}</div>
                                <span className="text-[10px] text-zinc-400 font-mono">{l.code}</span>
                              </div>
                            </div>
                          </label>
                        );
                  ...
                  <div className="p-3 bg-zinc-50 border border-zinc-200 rounded-xl text-zinc-500 text-[11px] leading-relaxed">
          ...
          footer={
            <div className="flex items-center gap-2 w-full">
              <button
                ...
                className="flex-1 py-2 bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl font-medium flex items-center justify-center gap-1.5 text-xs cursor-pointer shadow-xs"
              >
              ...
              <button
                ...
                className="px-3.5 py-2 border border-zinc-200 hover:bg-zinc-50 text-zinc-700 rounded-xl font-medium text-xs cursor-pointer"
              >
        ...
        >
          <div className="space-y-4 text-xs">
            ...
            <div className="bg-zinc-50 rounded-xl p-3.5 border border-zinc-200 space-y-2">
              ...
              <div className="text-[11px] text-zinc-600">{viewingDetailApp.description}</div>
              <div className="pt-2 border-t border-zinc-200/60 font-mono text-[11px] space-y-1">
                <div>
                  <span className="text-zinc-400">默认货币: </span>
                  <strong className="text-zinc-800">{viewingDetailApp.defaultCurrency}</strong>
                </div>
                <div>
                  <span className="text-zinc-400">Webhook: </span>
                  <span className="text-zinc-800 break-all">{viewingDetailApp.webhookUrl}</span>
                </div>
              </div>
            </div>
                ...
                {viewingDetailApp.associatedProductCodes && viewingDetailApp.associatedProductCodes.length > 0 ? (
                  viewingDetailApp.associatedProductCodes.map((code) => {
                    ...
                    return (
                      <div
                        key={code}
                        className="bg-white p-1.5 rounded border border-zinc-200/80 flex items-center justify-between"
                      >
                        <span className="text-zinc-800 font-bold">{code}</span>
                  ...
                  <span className="text-zinc-400 font-sans text-xs">默认全量在售商品均可结算</span>
                )}
              </div>
            </div>
            ...
            <div className="bg-zinc-50 rounded-xl p-3.5 border border-zinc-200 space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5 font-mono text-[11px]">
                {viewingDetailApp.associatedDiscountCodes && viewingDetailApp.associatedDiscountCodes.length > 0 ? (
                  ...
                  <span className="text-zinc-400 font-sans text-xs">全场折扣码均可兑换</span>
                )}
              </div>
            </div>
            ...
            <div className="bg-zinc-50 rounded-xl p-3.5 border border-zinc-200 space-y-2">
              ...
              <div className="pt-1 flex flex-wrap gap-1 text-[10px]">
                {viewingDetailApp.enabledEmailEvents?.map((evt) => (
                  <span key={evt} className="bg-zinc-200 text-zinc-700 px-1.5 py-0.5 rounded font-mono">
                    {evt}
                  </span>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                {viewingDetailApp.supportedLanguages?.map((lang) => {
                  ...
                  return (
                    <span
                      key={lang}
                      className="px-2 py-1 bg-white border border-zinc-200 rounded-lg flex items-center gap-1.5 text-zinc-800 font-medium"
                    >
                      <span>{item?.flag}</span>
